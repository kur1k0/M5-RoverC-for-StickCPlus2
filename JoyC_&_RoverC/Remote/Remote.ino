...
LGFX_Sprite Disbuff = LGFX_Sprite(&M5.Lcd);
...
uint8_t SendBuff[8] = {0xAA, 0x55, SYSNUM, 0x00, 0x00, 0x00, 0x00, 0xee};
...
void setup() {
    ...
    */
    M5.update();
    if ((EEPROM.read(0) != 0x56) || (M5.BtnA.isPressed() == 0)) {
        WiFi.mode(WIFI_STA);
